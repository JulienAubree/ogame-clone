...
const KEYS: GameplayKey[] = [
  ...
  { key: 'flagship_repair_time', label: 'Temps reparation flagship', description: 'Reduit le temps de reparation du vaisseau amiral apres incapacitation', category: 'talent_global', source: 'Talent global_bonus', consumer: 'flagship.service.ts incapacitate()', formula: 'repairSeconds = base / (1 + bonus)', example: 'mil_repair: +15%/rang × 3 = 7200/1.45 ≈ 4966s' },
  ...
  { key: 'mining_speed', label: 'Vitesse de minage', description: 'Reduit la duree de la phase de minage en mission PvE', category: 'talent_global', source: 'Talent global_bonus', consumer: 'mine.handler.ts processProspectDone()', formula: 'duration = base / (1 + bonus)', example: 'ind_mining_speed: +15%/rang × 3 = /1.45' },
  { key: 'prospection_speed', label: 'Vitesse de prospection', description: 'Reduit la duree de la phase de prospection en mission PvE', category: 'talent_global', source: 'Talent global_bonus', consumer: 'mine.handler.ts processArrival()', formula: 'duration = base / (1 + bonus)', example: 'ind_prospect_speed: +15%/rang × 3 = /1.45' },
