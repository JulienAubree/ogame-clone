...
const KEYS: GameplayKey[] = [
  ...
  { key: 'military_parallel_build', label: 'Construction parallele', description: '+1 file de construction militaire', category: 'talent_global', source: 'Talent global_bonus', consumer: 'shipyard.service.ts', formula: 'slots = 1 + bonus', example: 'combat_war_march: +1' },
