...
export default function Defense() {
  ...
  return (
    <div className="space-y-4 p-4 lg:space-y-6 lg:p-6">
      ...
      >
        {detailId && <DefenseDetailContent defenseId={detailId} researchLevels={researchLevels} buildingLevels={buildingLevels} timePerUnit={defenses?.find(d => d.id === detailId)?.timePerUnit} planetClassId={planetClassId} />}
      </EntityDetailOverlay>
