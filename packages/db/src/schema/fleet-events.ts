...
export const fleetMissionEnum = pgEnum('fleet_mission', [
  'transport', 'station', 'spy', 'attack', 'colonize', 'recycle', 'mine', 'pirate', 'trade', 'scan', 'explore', 'colonize_supply', 'colonize_reinforce', 'colonization_raid', 'abandon_return', 'anomaly',
]);
