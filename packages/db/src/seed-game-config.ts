...
const TUTORIAL_QUESTS = [
  ...
  { id: 'quest_14', order: 14, title: "Chasseur d'epaves", narrativeText: "Le recuperateur collecte les debris spatiaux.", conditionType: 'ship_count', conditionTargetId: 'explorer', conditionTargetValue: 1, rewardMinerai: 825, rewardSilicium: 500, rewardHydrogene: 175, conditionLabel: 'Recuperateur x1', chapterId: 'chapter_3', journalEntry: "Jour 63 — Les plans du recuperateur sont prets. Un petit vaisseau pas cher, parfait pour aller gratter les champs de debris avant qu'ils ne se dispersent.", objectiveLabel: 'Recuperateur' },
