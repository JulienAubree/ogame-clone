...
const TUTORIAL_QUESTS = [
  ...
  { id: 'quest_15', order: 15, title: "Chasseur d'epaves", narrativeText: "Le recuperateur collecte les debris spatiaux.", conditionType: 'ship_count', conditionTargetId: 'recuperateur', conditionTargetValue: 1, rewardMinerai: 3500, rewardSilicium: 1500, rewardHydrogene: 600, conditionLabel: 'Recuperateur x1', chapterId: 'chapter_3', journalEntry: "Jour 63 — Les plans du recuperateur sont prets. Un petit vaisseau pas cher, parfait pour aller gratter les champs de debris avant qu'ils ne se dispersent.", objectiveLabel: 'Recuperateur' },
  { id: 'quest_16', order: 16, title: 'Premier prospecteur', narrativeText: "Le prospecteur extrait des ressources des asteroides.", conditionType: 'ship_count', conditionTargetId: 'prospector', conditionTargetValue: 1, rewardMinerai: 1000, rewardSilicium: 600, rewardHydrogene: 250, conditionLabel: 'Prospecteur x1', chapterId: 'chapter_3', journalEntry: "Jour 68 — Les debris, c'est bien. Mais les ceintures d'asteroides, c'est mieux. Un prospecteur pourrait en extraire des tonnes de ressources brutes.", objectiveLabel: 'Prospecteur' },
