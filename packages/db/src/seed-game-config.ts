...
const SHIPS = [
  ...
  { id: 'interceptor', name: 'Intercepteur', description: 'Vaisseau de combat de base.', costMinerai: 3000, costSilicium: 1000, costHydrogene: 0, countColumn: 'interceptor', baseSpeed: 12500, fuelConsumption: 20, cargoCapacity: 50, driveType: 'combustion', weapons: 4, shield: 8, hull: 12, baseArmor: 1, shotCount: 3, combatCategoryId: 'light', categoryId: 'ship_combat', sortOrder: 8, role: 'combat', flavorText: "Le chasseur leger, pilier des premieres flottes, compense sa fragilite par son faible cout de production.", weaponProfiles: [
...
const DEFENSES = [
  ...
  { id: 'plasmaTurret', name: 'Artillerie à ions', description: 'Défense plasma dévastatrice.', costMinerai: 50000, costSilicium: 50000, costHydrogene: 30000, countColumn: 'plasmaTurret', weapons: 90, shield: 60, hull: 140, baseArmor: 7, shotCount: 1, combatCategoryId: 'heavy', maxPerPlanet: null, categoryId: 'defense_tourelles', sortOrder: 4, flavorText: "La tourelle a plasma genere un flux de particules ionisees capable de vaporiser les blindages les plus epais.", weaponProfiles: [
