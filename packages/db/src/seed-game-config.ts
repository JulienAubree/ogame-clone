...
const RESEARCH = [
  ...
  { id: 'rockFracturing', name: 'Technologie de fracturation des roches', description: "Ameliore les techniques d'extraction miniere, augmentant la capacite d'extraction de 15% par niveau et reduisant la duree de minage.", baseCostMinerai: 2000, baseCostSilicium: 4000, baseCostHydrogene: 1000, costFactor: 2, levelColumn: 'rockFracturing', categoryId: 'research_sciences', sortOrder: 9, flavorText: "Des ondes de choc calibrees fracturent la roche asteroidale, augmentant considerablement la quantite de minerai extraite et accelerant les operations de minage.", effectDescription: "Chaque niveau augmente la capacite d'extraction de 15%, ce qui reduit proportionnellement la duree de minage.", prerequisites: { buildings: [{ buildingId: 'missionCenter', level: 1 }], research: [{ researchId: 'combustion', level: 3 }] } },
