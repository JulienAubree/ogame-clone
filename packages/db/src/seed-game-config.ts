...
const BUILDINGS = [
  { id: 'mineraiMine', name: 'Mine de minerai', description: 'Produit du minerai, ressource de base.', baseCostMinerai: 60, baseCostSilicium: 15, baseCostHydrogene: 0, costFactor: 1.5, baseTime: 60, levelColumn: 'mineraiMineLevel', categoryId: 'building_industrie', sortOrder: 0, prerequisites: [] as { buildingId: string; level: number }[] },
  { id: 'siliciumMine', name: 'Mine de silicium', description: 'Produit du silicium.', baseCostMinerai: 48, baseCostSilicium: 24, baseCostHydrogene: 0, costFactor: 1.6, baseTime: 60, levelColumn: 'siliciumMineLevel', categoryId: 'building_industrie', sortOrder: 1, prerequisites: [] },
  { id: 'hydrogeneSynth', name: "Synthétiseur d'hydrogène", description: "Produit de l'hydrogène.", baseCostMinerai: 225, baseCostSilicium: 75, baseCostHydrogene: 0, costFactor: 1.5, baseTime: 60, levelColumn: 'hydrogeneSynthLevel', categoryId: 'building_industrie', sortOrder: 2, prerequisites: [] },
  { id: 'solarPlant', name: 'Centrale solaire', description: "Produit de l'énergie.", baseCostMinerai: 75, baseCostSilicium: 30, baseCostHydrogene: 0, costFactor: 1.5, baseTime: 60, levelColumn: 'solarPlantLevel', categoryId: 'building_industrie', sortOrder: 3, prerequisites: [] },
  { id: 'robotics', name: 'Usine de robots', description: 'Réduit le temps de construction.', baseCostMinerai: 400, baseCostSilicium: 120, baseCostHydrogene: 200, costFactor: 2, baseTime: 60, levelColumn: 'roboticsLevel', categoryId: 'building_defense', sortOrder: 4, prerequisites: [] },
  { id: 'shipyard', name: 'Chantier spatial', description: 'Construit vaisseaux et défenses.', baseCostMinerai: 400, baseCostSilicium: 200, baseCostHydrogene: 100, costFactor: 2, baseTime: 60, levelColumn: 'shipyardLevel', categoryId: 'building_defense', sortOrder: 5, prerequisites: [{ buildingId: 'robotics', level: 2 }] },
  { id: 'researchLab', name: 'Laboratoire de recherche', description: 'Permet les recherches.', baseCostMinerai: 200, baseCostSilicium: 400, baseCostHydrogene: 200, costFactor: 2, baseTime: 60, levelColumn: 'researchLabLevel', categoryId: 'building_recherche', sortOrder: 6, prerequisites: [] },
  { id: 'storageMinerai', name: 'Entrepôt de minerai', description: 'Augmente le stockage de minerai.', baseCostMinerai: 1000, baseCostSilicium: 0, baseCostHydrogene: 0, costFactor: 2, baseTime: 60, levelColumn: 'storageMineraiLevel', categoryId: 'building_stockage', sortOrder: 7, prerequisites: [] },
  { id: 'storageSilicium', name: 'Entrepôt de silicium', description: 'Augmente le stockage de silicium.', baseCostMinerai: 1000, baseCostSilicium: 500, baseCostHydrogene: 0, costFactor: 2, baseTime: 60, levelColumn: 'storageSiliciumLevel', categoryId: 'building_stockage', sortOrder: 8, prerequisites: [] },
  { id: 'storageHydrogene', name: "Réservoir d'hydrogène", description: "Augmente le stockage d'hydrogène.", baseCostMinerai: 1000, baseCostSilicium: 1000, baseCostHydrogene: 0, costFactor: 2, baseTime: 60, levelColumn: 'storageHydrogeneLevel', categoryId: 'building_stockage', sortOrder: 9, prerequisites: [] },
];
