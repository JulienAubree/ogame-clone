...
const SHIPS = [
  ...
  { id: 'explorer', name: 'Récupérateur', description: "Mini recycleur early-game pour collecter les débris spatiaux.", costMinerai: 2000, costSilicium: 1000, costHydrogene: 0, countColumn: 'explorer', baseSpeed: 2000, fuelConsumption: 15, cargoCapacity: 2000, driveType: 'combustion', weapons: 1, shield: 10, hull: 20, baseArmor: 0, shotCount: 1, combatCategoryId: 'support', categoryId: 'ship_utilitaire', sortOrder: 1, role: 'recycler', flavorText: "Compact et economique, le recuperateur est le premier vaisseau capable de collecter les debris des batailles spatiales. Sa petite soute le rend ideal pour les jeunes empires.", prerequisites: { buildings: [{ buildingId: 'shipyard', level: 4 }], research: [{ researchId: 'combustion', level: 1 }] } },
