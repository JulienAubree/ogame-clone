...
const BUILDINGS = [
  ...
  { id: 'planetaryShield', name: 'Bouclier planétaire', description: "Génère un champ de force protégeant la planète. Sa puissance est réglable pour économiser l'énergie.", baseCostMinerai: 2000, baseCostSilicium: 2000, baseCostHydrogene: 0, costFactor: 1.5, baseTime: 7200, categoryId: 'building_defense', sortOrder: 0, role: 'planetaryShield', flavorText: "Un dôme d'énergie pure enveloppe la planète. En combat, le bouclier est indestructible et se régénère à chaque round. Il ne protège pas votre flotte, mais tant qu'il n'est pas percé, vos défenses planétaires sont intouchables. Sa puissance est réglable dans les paramètres d'énergie.", prerequisites: [] as { buildingId: string; level: number }[] },
];
...
const SHIPS = [
  ...
  { id: 'interceptor', name: 'Intercepteur', description: 'Vaisseau de combat de base.', costMinerai: 3000, costSilicium: 1000, costHydrogene: 0, countColumn: 'interceptor', baseSpeed: 12500, fuelConsumption: 20, cargoCapacity: 50, driveType: 'combustion', weapons: 4, shield: 8, hull: 12, baseArmor: 1, shotCount: 3, combatCategoryId: 'light', categoryId: 'ship_combat', sortOrder: 8, role: 'combat', flavorText: "Le chasseur leger, pilier des premieres flottes, compense sa fragilite par son faible cout de production.", prerequisites: { buildings: [{ buildingId: 'commandCenter', level: 1 }], research: [{ researchId: 'combustion', level: 1 }] } },
...
const TUTORIAL_CHAPTERS = [
  ...
  { id: 'chapter_3', title: "L'espace", journalIntro: "Le chantier spatial est operationnel. L'espace est immense, dangereux, et plein de debris. Mais c'est la que se trouvent les ressources dont on a besoin pour grandir.", order: 3, rewardMinerai: 0, rewardSilicium: 0, rewardHydrogene: 0, rewardExilium: 10, rewardUnits: [{ shipId: 'recuperateur', quantity: 2 }, { shipId: 'prospector', quantity: 1 }] },
...
const TUTORIAL_QUESTS = [
  ...
  { id: 'quest_4', order: 4, title: 'Reserves', narrativeText: "Stockez vos ressources en securite.", conditionType: 'building_level', conditionTargetId: 'storageMinerai', conditionTargetValue: 2, rewardMinerai: 150, rewardSilicium: 75, rewardHydrogene: 0, conditionLabel: 'Hangar minerai Nv.2', chapterId: 'chapter_1', journalEntry: "Jour 8 — La production tourne, mais le minerai s'accumule a meme le sol. On perd des ressources a chaque tempete. Il faut un hangar digne de ce nom.", objectiveLabel: 'Hangar minerai' },
  ...
  { id: 'quest_13', order: 13, title: 'Chantier avance', narrativeText: "Agrandissez le chantier pour des vaisseaux specialises.", conditionType: 'building_level', conditionTargetId: 'shipyard', conditionTargetValue: 4, rewardMinerai: 700, rewardSilicium: 400, rewardHydrogene: 150, conditionLabel: 'Chantier spatial Nv.4', chapterId: 'chapter_3', journalEntry: "Jour 58 — Le premier vol a revele l'ampleur des debris en orbite. Pour en tirer profit, il faut agrandir le chantier et construire des vaisseaux specialises.", objectiveLabel: 'Chantier spatial' },
  { id: 'quest_14', order: 14, title: "Chasseur d'epaves", narrativeText: "Le recuperateur collecte les debris spatiaux.", conditionType: 'ship_count', conditionTargetId: 'recuperateur', conditionTargetValue: 1, rewardMinerai: 825, rewardSilicium: 500, rewardHydrogene: 175, conditionLabel: 'Recuperateur x1', chapterId: 'chapter_3', journalEntry: "Jour 63 — Les plans du recuperateur sont prets. Un petit vaisseau pas cher, parfait pour aller gratter les champs de debris avant qu'ils ne se dispersent.", objectiveLabel: 'Recuperateur' },
  { id: 'quest_15', order: 15, title: 'Premier prospecteur', narrativeText: "Le prospecteur extrait des ressources des asteroides.", conditionType: 'ship_count', conditionTargetId: 'prospector', conditionTargetValue: 1, rewardMinerai: 950, rewardSilicium: 550, rewardHydrogene: 200, conditionLabel: 'Prospecteur x1', chapterId: 'chapter_3', journalEntry: "Jour 68 — Les debris, c'est bien. Mais les ceintures d'asteroides, c'est mieux. Un prospecteur pourrait en extraire des tonnes de ressources brutes.", objectiveLabel: 'Prospecteur' },
  { id: 'quest_16', order: 16, title: 'Oreilles ouvertes', narrativeText: "Le centre de missions detecte les opportunites.", conditionType: 'building_level', conditionTargetId: 'missionCenter', conditionTargetValue: 1, rewardMinerai: 1050, rewardSilicium: 550, rewardHydrogene: 200, conditionLabel: 'Centre de missions Nv.1', chapterId: 'chapter_3', journalEntry: "Jour 72 — On capte de plus en plus de signaux en provenance du systeme. Un centre de missions nous permettrait d'analyser ces donnees et de localiser les opportunites — gisements, epaves, anomalies.", objectiveLabel: 'Centre de missions' },
  { id: 'quest_17', order: 17, title: 'Premiere recolte', narrativeText: "Envoyez votre premiere mission de minage.", conditionType: 'mission_complete', conditionTargetId: 'mine', conditionTargetValue: 1, rewardMinerai: 1100, rewardSilicium: 625, rewardHydrogene: 250, conditionLabel: 'Mission de minage', chapterId: 'chapter_3', journalEntry: "Jour 75 — Le prospecteur est pret. Les scanners ont repere un gisement prometteur. C'est l'heure d'envoyer notre premiere mission de minage.", objectiveLabel: 'Mission de minage' },

  // Chapter 4: La menace
  { id: 'quest_18', order: 18, title: "Etat d'alerte", narrativeText: "Construisez un centre de commandement.", conditionType: 'building_level', conditionTargetId: 'commandCenter', conditionTargetValue: 1, rewardMinerai: 1250, rewardSilicium: 700, rewardHydrogene: 275, conditionLabel: 'Centre de commandement Nv.1', chapterId: 'chapter_4', journalEntry: "Jour 82 — J'ai convoque un conseil d'urgence. On a besoin d'un centre de commandement pour coordonner nos defenses. C'est la priorite absolue.", objectiveLabel: 'Centre de commandement' },
  { id: 'quest_19', order: 19, title: 'Premiere ligne', narrativeText: "Les intercepteurs sont rapides et maniables.", conditionType: 'ship_count', conditionTargetId: 'interceptor', conditionTargetValue: 3, rewardMinerai: 1400, rewardSilicium: 825, rewardHydrogene: 275, conditionLabel: 'Intercepteur x3', chapterId: 'chapter_4', journalEntry: "Jour 86 — Le centre de commandement est operationnel. Les ingenieurs ont finalise les plans des intercepteurs. Rapides, maniables, pas chers — exactement ce qu'il nous faut.", objectiveLabel: 'Intercepteurs' },
  { id: 'quest_20', order: 20, title: 'Puissance de feu', narrativeText: "L'armement ameliore les degats de vos vaisseaux.", conditionType: 'research_level', conditionTargetId: 'weapons', conditionTargetValue: 1, rewardMinerai: 1050, rewardSilicium: 1050, rewardHydrogene: 350, conditionLabel: 'Armement Nv.1', chapterId: 'chapter_4', journalEntry: "Jour 90 — Les intercepteurs sont en vol d'essai. Mais leurs armes sont trop faibles. La recherche en armement pourrait changer la donne.", objectiveLabel: 'Armement' },
  { id: 'quest_21', order: 21, title: 'Blindage', narrativeText: "Les boucliers protegent vos vaisseaux.", conditionType: 'research_level', conditionTargetId: 'shielding', conditionTargetValue: 1, rewardMinerai: 1050, rewardSilicium: 1050, rewardHydrogene: 350, conditionLabel: 'Bouclier Nv.1', chapterId: 'chapter_4', journalEntry: "Jour 95 — Les tirs de nos intercepteurs sont plus precis, mais ils ne tiennent pas les impacts. Il faut renforcer les boucliers.", objectiveLabel: 'Bouclier' },
  { id: 'quest_22', order: 22, title: 'Forteresse', narrativeText: "Les defenses planetaires protegent votre colonie.", conditionType: 'defense_count', conditionTargetId: 'lightLaser', conditionTargetValue: 4, rewardMinerai: 1400, rewardSilicium: 700, rewardHydrogene: 350, conditionLabel: 'Artillerie laser x4', chapterId: 'chapter_4', journalEntry: "Jour 100 — On ne peut pas tout miser sur la flotte. Des tourelles au sol protegeraient la colonie meme en notre absence.", objectiveLabel: 'Artillerie laser legere' },
  { id: 'quest_23', order: 23, title: 'Bapteme du feu', narrativeText: "Attaquez un repaire pirate.", conditionType: 'mission_complete', conditionTargetId: 'pirate', conditionTargetValue: 1, rewardMinerai: 1750, rewardSilicium: 1050, rewardHydrogene: 500, conditionLabel: 'Mission pirate', chapterId: 'chapter_4', journalEntry: "Jour 105 — Un repaire pirate a ete localise. C'est le moment de tester notre preparation. Si on survit a ca, on survivra a tout.", objectiveLabel: 'Mission pirate' },
];
